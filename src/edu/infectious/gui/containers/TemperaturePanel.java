...
public class TemperaturePanel extends JPanel {
	...
	private static final Color BUTTON_HOVER_COLOR = new Color(0.478f, 0.478f,
			0.478f);
	private static final Color BUTTON_BUY_COLOR = new Color(0.149f, 0.451f,
			0.925f);
	...
	private void setupListeners() {
		addMouseMotionListener(new MouseMotionListener() {
			...
			private void resetButtonColor() {
				if (VirusStatistics
						.isMaxTemperatureLevel(CountryClimateTemperature.HOT))
					hotButton.setFillColor(BUTTON_BUY_COLOR);
				else
					hotButton.setFillColor(BUTTON_COLOR);
				if (VirusStatistics
						.isMaxTemperatureLevel(CountryClimateTemperature.COLD))
					coldButton.setFillColor(BUTTON_BUY_COLOR);
				else
					coldButton.setFillColor(BUTTON_COLOR);
				if (VirusStatistics
						.isMaxTemperatureLevel(CountryClimateTemperature.TEMPERATE))
	...
	private void handleHot() {
		if (!VirusStatistics
				.isMaxTemperatureLevel(CountryClimateTemperature.HOT)) {
			switch (VirusStatistics
					.getTemperatureLevel(CountryClimateTemperature.HOT)) {
			case 0:
				if (Game.getPlayer().isAffordable(
						VirusStatistics.getLevel1Cost())) {
					VirusStatistics
							.incrementTemperatureBonus(CountryClimateTemperature.HOT);
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel1Cost());
					hotButton.setText("Hot level 2 ("
	...
	private void handleCold() {
		if (!VirusStatistics
				.isMaxTemperatureLevel(CountryClimateTemperature.COLD)) {
			switch (VirusStatistics
					.getTemperatureLevel(CountryClimateTemperature.COLD)) {
			case 0:
				if (Game.getPlayer().isAffordable(
						VirusStatistics.getLevel1Cost())) {
					VirusStatistics
							.incrementTemperatureBonus(CountryClimateTemperature.COLD);
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel1Cost());
					coldButton.setText("Cold level 2 ("
							+ VirusStatistics.getLevel2Cost() + ")");
				}
				break;
			case 1:
				if (Game.getPlayer().isAffordable(
					...
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel2Cost());
					coldButton.setText("Cold level 3 ("
							+ VirusStatistics.getLevel3Cost() + ")");
				}
				break;
			case 2:
				if (Game.getPlayer().isAffordable(
					...
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel3Cost());
					coldButton.setText("Cold level 4 ("
							+ VirusStatistics.getLevel4Cost() + ")");
				}
				break;
			case 3:
		...
		if (!VirusStatistics
			...
			case 0:
				if (Game.getPlayer().isAffordable(
						VirusStatistics.getLevel1Cost())) {
					VirusStatistics
							.incrementTemperatureBonus(CountryClimateTemperature.TEMPERATE);
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel1Cost());
					temperateButton.setText("Temperate level 2 ("
							+ VirusStatistics.getLevel2Cost() + ")");
				}
				break;
			case 1:
				if (Game.getPlayer().isAffordable(
					...
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel2Cost());
					temperateButton.setText("Temperate level 3 ("
							+ VirusStatistics.getLevel3Cost() + ")");
				}
				break;
			case 2:
				if (Game.getPlayer().isAffordable(
					...
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel3Cost());
					temperateButton.setText("Temperate level 4 ("
							+ VirusStatistics.getLevel4Cost() + ")");
				}
				break;
			case 3:
