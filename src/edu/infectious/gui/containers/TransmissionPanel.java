...
public class TransmissionPanel extends JPanel {
	...
	private void setupButtons() {
		// Air button
		String airText = VirusStatistics.isAirTransmission() ? "Air" : "Air (" + VirusStatistics.getAirTransmissionCost() + ")";
		...
		airButton = new Button(20, 50, BUTTON_WIDTH, BUTTON_HEIGHT,
				BUTTON_LINE_WIDTH, airText, airColor, BUTTON_LINE_COLOR);
		
		// Water button
		String waterText = VirusStatistics.isWaterTransmission() ? "Water" : "Water (" + VirusStatistics.getWaterTransmissionCost() + ")";
		...
		waterButton = new Button(20, 95, BUTTON_WIDTH, BUTTON_HEIGHT,
				BUTTON_LINE_WIDTH, waterText, waterColor, BUTTON_LINE_COLOR);
		
		// Plague button
		String plagueText = VirusStatistics.isPlagueTransmission() ? "Plague" : "Plague (" + VirusStatistics.getPlagueTransmissionCost() + ")";
		Color plagueColor = VirusStatistics.isPlagueTransmission() ? BUTTON_BUY_COLOR : BUTTON_COLOR;
		plagueButton = new Button(20, 140, BUTTON_WIDTH, BUTTON_HEIGHT,
				BUTTON_LINE_WIDTH, plagueText, plagueColor, BUTTON_LINE_COLOR);
		
		// Livestock button
		String livestockText = VirusStatistics.isLivestockTransmission() ? "Livestock" : "Livestock (" + VirusStatistics.getPlagueTransmissionCost() + ")";
		Color livestockColor = VirusStatistics.isLivestockTransmission() ? BUTTON_BUY_COLOR : BUTTON_COLOR;
		livestockButton = new Button(20, 185, BUTTON_WIDTH, BUTTON_HEIGHT,
				BUTTON_LINE_WIDTH, livestockText, livestockColor,
				BUTTON_LINE_COLOR);
	}
