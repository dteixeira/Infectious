...
public class TraitPanel extends JPanel {
	...
	private void handleClose() {
		((TraitsDialog) (TraitPanel.this.getParent().getParent()
	...
	private void setupButtons() {
		buyButton = new Button(15, 525, BUTTON_WIDTH, BUTTON_HEIGHT,
				BUTTON_LINE_WIDTH, "", BUTTON_COLOR, BUTTON_LINE_COLOR);
