...
public class HumidityPanel extends JPanel {
	...
	private void handleArid() {
		if (!VirusStatistics.isMaxHumidityLevel(CountryClimateHumidity.ARID)) {
			switch (VirusStatistics
					.getHumidityLevel(CountryClimateHumidity.ARID)) {
			case 0:
				if (Game.getPlayer().isAffordable(
						VirusStatistics.getLevel1Cost())) {
					VirusStatistics
							.incrementHumidityBonus(CountryClimateHumidity.ARID);
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel1Cost());
					aridButton.setText("Arid level 2 ("
			...
			case 1:
				if (Game.getPlayer().isAffordable(
					...
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel2Cost());
					aridButton.setText("Arid level 3 ("
			...
			case 2:
				if (Game.getPlayer().isAffordable(
					...
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel3Cost());
					aridButton.setText("Arid level 4 ("
	...
	private void handleTropical() {
		if (!VirusStatistics
				.isMaxHumidityLevel(CountryClimateHumidity.TROPICAL)) {
			switch (VirusStatistics
					.getHumidityLevel(CountryClimateHumidity.TROPICAL)) {
			case 0:
				if (Game.getPlayer().isAffordable(
						VirusStatistics.getLevel1Cost())) {
					VirusStatistics
							.incrementHumidityBonus(CountryClimateHumidity.TROPICAL);
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel1Cost());
					tropicalButton.setText("Tropical level 2 ("
							+ VirusStatistics.getLevel2Cost() + ")");
				}
				break;
			case 1:
				if (Game.getPlayer().isAffordable(
					...
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel2Cost());
					tropicalButton.setText("Tropical level 3 ("
							+ VirusStatistics.getLevel3Cost() + ")");
				}
				break;
			case 2:
				if (Game.getPlayer().isAffordable(
					...
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel3Cost());
					tropicalButton.setText("Tropical level 4 ("
							+ VirusStatistics.getLevel4Cost() + ")");
				}
				break;
			case 3:
		...
		if (!VirusStatistics
			...
			case 0:
				if (Game.getPlayer().isAffordable(
						VirusStatistics.getLevel1Cost())) {
					VirusStatistics
							.incrementHumidityBonus(CountryClimateHumidity.MEDITERRANEAN);
					Game.getPlayer().spendPoints(
							VirusStatistics.getLevel1Cost());
